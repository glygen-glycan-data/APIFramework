...
class GlycanConverter(APIFrameworkWithFrontEnd):
...
if __name__ == '__main__':
    ...
    glycanconverter_app = GlycanConverter()
    glycanconverter_app.find_config("GlycanConverter.ini")
    glycanconverter_app.start()
